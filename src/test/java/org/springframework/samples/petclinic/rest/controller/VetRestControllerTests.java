...
import org.springframework.samples.petclinic.vets.web.VetRestController;
...
class VetRestControllerTests {
    ...
    void testGetVetSuccess() throws Exception {
    	given(this.vetService.findById(1)).willReturn(vets.get(0));
    ...
    void testGetVetNotFound() throws Exception {
    	given(this.vetService.findById(999)).willReturn(null);
    ...
    void testGetAllVetsSuccess() throws Exception {
    	given(this.vetService.findAll()).willReturn(vets);
