...
import org.springframework.samples.petclinic.common.ExceptionControllerAdvice;
...
import org.springframework.samples.petclinic.owners.web.OwnerRestController;
...
class OwnerRestControllerTests {
    ...
    void testGetOwnerSuccess() throws Exception {
        given(this.ownerService.findById(1)).willReturn(ownerMapper.toOwner(owners.get(0)));
    ...
    void testGetOwnerNotFound() throws Exception {
        given(this.ownerService.findById(2)).willReturn(null);
    ...
    void testGetOwnersListSuccess() throws Exception {
        owners.remove(0);
        owners.remove(1);
        given(this.ownerService.findByLastName("Davis")).willReturn(ownerMapper.toOwners(owners));
    ...
    void testGetOwnersListNotFound() throws Exception {
        owners.clear();
        given(this.ownerService.findByLastName("0")).willReturn(ownerMapper.toOwners(owners));
    ...
    void testGetAllOwnersSuccess() throws Exception {
        owners.remove(0);
        owners.remove(1);
        given(this.ownerService.findAll()).willReturn(ownerMapper.toOwners(owners));
    ...
    void testDeleteOwnerSuccess() throws Exception {
        ...
        given(this.ownerService.findById(1)).willReturn(owner);
    ...
    void testDeleteOwnerError() throws Exception {
        ...
        mapper.registerModule(new JavaTimeModule());
        String newOwnerAsJSON = mapper.writeValueAsString(newOwnerDto);
        given(this.ownerService.findById(999)).willReturn(null);
    ...
    void testGetOwnerPetSuccess() throws Exception {
        ...
        given(this.ownerService.findById(2)).willReturn(owner);
        var pet = petMapper.toPet(pets.get(0));
        pet.setOwner(owner);
        given(this.petService.findById(1)).willReturn(pet);
    ...
    void testGetOwnersPetsWithPetNotFound() throws Exception {
        ...
        given(this.ownerService.findById(1)).willReturn(owner1);
    ...
    void testUpdateOwnersPetSuccess() throws Exception {
        ...
        given(this.ownerService.findById(ownerId)).willReturn(ownerMapper.toOwner(owners.get(0)));
        given(this.petService.findById(petId)).willReturn(petMapper.toPet(pets.get(0)));
    ...
    void testUpdateOwnersPetOwnerNotFound() throws Exception {
        int ownerId = 0;
        int petId = pets.get(0).getId();
        given(this.ownerService.findById(ownerId)).willReturn(null);
    ...
    void testUpdateOwnersPetPetNotFound() throws Exception {
        ...
        int petId = 0;
        given(this.ownerService.findById(ownerId)).willReturn(ownerMapper.toOwner(owners.get(0)));
        given(this.petService.findById(petId)).willReturn(null);
        PetDto petDto = pets.get(0);
